...
//static Byte ivBuff[]   = {0,3,9,2,0,3,9,2,0,3,9,2,0,3,0,0};
//static Byte ivBuff[]   = {0x0,0x3,0x9,0x2,0x0,0x3,0x9,0x2,0x0,0x3,0x9,0x2,0x0,0x3,0,0};
//
...
/*加密方法*/
+ (NSString *)AES256EncryptWithPlainText:(NSString *)plain  key:(NSString *)uuid
{
...
//    [PASSWORD getCString:keyPtr maxLength:sizeof(keyPtr) encoding:NSUTF8StringEncoding];
    [uuid getCString:keyPtr maxLength:sizeof(keyPtr) encoding:NSUTF8StringEncoding];
...
/*解密方法*/
+ (NSString *)AES256DecryptWithCiphertext:(NSString *)ciphertexts key:(NSString *)uuid
{
...
//    [PASSWORD getCString:keyPtr maxLength:sizeof(keyPtr) encoding:NSUTF8StringEncoding];
	...
	CCCryptorStatus cryptStatus = CCCrypt(kCCDecrypt,
                                          ...
                                          kCCOptionPKCS7Padding | kCCOptionECBMode,
//                                          kCCOptionECBMode,
//										  [[NSData AESKeyForPassword:PASSWORD] bytes],
                                          keyPtr,
                                          kCCKeySizeAES256,
//										  ivBuff ,/* initialization vector (optional) */
                                          NULL,
