...
- (NSString *)rsaEncryptText:(NSString *)text {
    NSData*tempData=[text dataUsingEncoding:NSUTF8StringEncoding];
    NSData *encryptedData = [self rsaEncryptData:tempData];
    NSString *base64EncryptedString = [ZSEncodeTool  encodeBase64Data:encryptedData];
